...
\setbeamercolor*{palette secondary}{use=structure,fg=white,bg=BrickRed}
\setbeamercolor*{palette tertiary}{use=structure,fg=white,bg=Dandelion}

% changing rounded blocks,comment to rounded and shadowed blocks
\setbeamertemplate{blocks}[default]

% changing rounded bullets and their color
\setbeamerfont{section number projected}{%
  family=\sffamily,series=\bfseries,size=\small}
\setbeamercolor{section number projected}{bg=Blue,fg=white}
\setbeamertemplate{sections/subsections in toc}[square] %ball, circle, square
